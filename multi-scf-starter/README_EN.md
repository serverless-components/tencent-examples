# Quickly create and deploy multi-scf-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy multi-scf-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the multi-scf-starter template by running this following command:

```bash
serverless init multi-scf-starter --name example
cd example
```
