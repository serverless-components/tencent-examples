# Quickly create and deploy a restful-api application

[中文](./README.md) | **English**

## Introduction

Easily deploy restful-api applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
