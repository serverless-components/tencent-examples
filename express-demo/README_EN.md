# Quickly create and deploy a express-demo application

[中文](./README.md) | **English**

## Introduction

Easily deploy express-demo applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the express-demo template by running this following command:
