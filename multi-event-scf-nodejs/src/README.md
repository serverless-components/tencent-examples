# 快速构建 multi-event-scf-nodejs

**中文** | [English](./README_EN.md)

## 简介

multi-event-scf-nodejs 模板使用 Tencent SCF 组件及其触发器能力，方便的在腾讯云创建，配置和管理一个 multi-event-scf-nodejs 应用。
...
可以通过以下命令移除 multi-event-scf-nodejs 应用
