# Quickly create and deploy a scf-demo application

[中文](./README.md) | **English**

## Introduction

Easily deploy scf-demo applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the scf-demo template by running this following command:
