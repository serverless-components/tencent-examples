# Quickly create and deploy multi-scf-db-starter application

[中文](./README.md) | **English**

## Introduction

Easily deploy multi-scf-db-starter applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the multi-scf-db-starter template by running this following command:
