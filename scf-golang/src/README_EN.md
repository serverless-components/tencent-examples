# Quickly create and deploy scf-golang application

[中文](./README.md) | **English**

## Introduction

Easily deploy scf-golang applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
