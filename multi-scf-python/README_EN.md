# Quickly create and deploy multi-scf-python application

[中文](./README.md) | **English**

## Introduction

Easily deploy multi-scf-python applications to Tencent Cloud's serverless infrastructure using this Serverless Framework Component.
...
Initializing the multi-scf-python template by running this following command:

```bash
serverless init multi-scf-python --name example
cd example
```
