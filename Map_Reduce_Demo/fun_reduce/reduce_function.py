...
region = u'ap-guangzhou'         # Modify the area according to the actual situation.根据实际情况，修改地域
result_bucket = os.environ.get('Bucket')       # Modify the bucket name according to the actual situation.根据实际情况，修改bucket名
